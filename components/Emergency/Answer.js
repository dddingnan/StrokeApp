...
export default class Answer extends Component {
  ...
  async componentWillMount(){
    ...
    let stage = this.props.state
    AsyncStorage.setItem('state',stage)

    if(this.props.inte=="0"){
      AsyncStorage.setItem('gonext',"0")
    }
    if(this.props.stro=="0"){
      AsyncStorage.setItem('gonext',"1")
    }
    if(this.props.gena=="0"){
      AsyncStorage.setItem('gonext',"2")
    }
  	...
  	if(this.props.state=='1'){
        ...
        一、要如何餵食
  		...
  		return(
  			...
  			<ScrollableTabView
  			initialPage={0}
  			tabBarBackgroundColor='#198ea6'
  			tabBarActiveTextColor='white'
  			tabBarInactiveTextColor='black'
  			tabBarUnderlineStyle={{backgroundColor:'#198ea6'}}
  			tabBarTextStyle={{fontSize: 18}}
  			style={{borderColor:'white',borderTopWidth:1}}
  			renderTabBar={() => <ScrollableTabBar />}
  			>
